...
urlpatterns = [
    ...
    url(r'^hooks/interactive_message$', feedback.views.receive_interactive_command),
    ...
    url(r'^feedback/sent$', feedback.views.sent_feedback, name='sent_feedback'),
    url(r'^feedback/new$', feedback.views.leave_new_feedback_page, name='new_feedback'),
    url(r'^feedback/new/random$', feedback.views.leave_new_feedback_page, name='new_feedback_random', kwargs={"random": True}),
    url(r'^feedback/new/question/(?P<question_id>[0-9A-Fa-f-]{32,36})$', feedback.views.leave_new_feedback_page, name='new_feedback_for_question'),
    url(r'^feedback/new/received$', feedback.views.feedback_received, name='feedback_received'),
